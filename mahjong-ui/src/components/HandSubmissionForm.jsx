// This is the old hand submission form from when the application was hosting lobby systems.
// As of V2.0, this application is now a central scoring hub.
// Keeping the code around in case I ever revert.
...
function HandSubmissionForm({ playerNames }) {
  ...
  const yakuDescriptions = {
    ...
    Ryanpeikou:
      "Two pairs of identical sequences (double iipeiko). Closed only.",
    ...
    Rinshan:
      "Win by tsumo on the supplemental tile drawn after declaring a kan.",
    Chankan:
  ...
  const [isDealer, setIsDealer] = useState(
    sessionPlayer.wind == room.roundWind,
  ); // This can be determined based on playerWind and roundWind
      ...
      {winningHandInfo && (
        <div className="winning-hand-info">
          ...
          <ul>
            ...
            <li>
              <strong>Additional Payment:</strong> {winningHandInfo.additional}
            </li>
            <li>
              <strong>Yaku:</strong>{" "}
      ...
      <form onSubmit={handleSubmit}>
        <div className="form-section">
          ...
          <div className="tile-summary">
            ...
            <p className="selected-tiles">Total tiles: {getTotalTiles()}</p>
